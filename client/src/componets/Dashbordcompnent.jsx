...
export default function Dashbordcompnent() {
       ...
       const fetchPost = async() => {
        ...
        try{
            ...
            if(res.ok){
               ...
               setLastMonthPosts(data.lasmonthpost)
            }
        ...
        <div className='flex flex-wrap gap-4 py-3 mx-auto justify-center'>
          <div className='flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800'>
            <div className='flex justify-between  p-3 text-sm font-semibold'>
              ...
              <Button outline gradientDuoTone='purpleToPink'>
                <Link to={'/dashbord?tab=users'}>See all</Link>
              </Button>
            </div>
            <Table hoverable>
              <Table.Head>
          ...
          <div className='flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800'>
            <div className='flex justify-between  p-3 text-sm font-semibold'>
              ...
              <Button outline gradientDuoTone='purpleToPink'>
                <Link to={'/dashbord?tab=coment'}>See all</Link>
              </Button>
            </div>
            <Table hoverable>
              <Table.Head>
          ...
          <div className='flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800'>
            <div className='flex justify-between  p-3 text-sm font-semibold'>
              ...
              <Button outline gradientDuoTone='purpleToPink'>
                <Link to={'/dashbord?tab=posts'}>See all</Link>
              </Button>
            </div>
            <Table hoverable>
              <Table.Head>
